...
public class CustomStringMethods {
  ...
  */
    public String pigLatin(String orig) {
        return orig.substring(1, orig.length()) + orig.substring(0, 1) + "ay";
    }
    ...
    */
    public String endUp(String myString, int numToCap){
        if (myString.length() < numToCap){
            ...
            int splitIndex = myString.length()-numToCap;
            return myString.substring(0, splitIndex) + myString.substring(splitIndex, myString.length()).toUpperCase();
        }
    }
